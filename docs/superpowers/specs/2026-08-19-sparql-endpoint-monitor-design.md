...
3. **The admission policy and the `unreachable-candidates` list.** What makes a daily sweep
   ...
   the dump had marked timed-out cost **two thirds** of the sweep. Until it is built the
...
accounted for 66% of the sweep. Both are true, and this project gates on the field in
neither direction.
